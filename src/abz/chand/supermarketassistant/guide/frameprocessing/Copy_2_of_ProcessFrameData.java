...
public class Copy_2_of_ProcessFrameData {

	private ColourRanges colourRanges;
	private List<Integer> dataValues;
	private int[] valueCounter;

	public Copy_2_of_ProcessFrameData(){
	...
	public List<Integer> getData(Mat mat, Point center){
		dataValues.clear();
		String ss = getWest(mat, center)
		+ " : " + getEast(mat, center) 
		+ " : " + getSouth(mat, center)
		+ " : " + getSouthWest(mat, center) 
		+ " : " + getSouthEast(mat, center) 
		+ " : " + getNorthWest(mat, center) 
		+ " : " + getNorthEast(mat, center);
		return dataValues;
	}
	...
	public String getSouthWest(Mat mat, Point center) {
		...
		offset = extractWestValue(mat, x, offset+5);
		data = findBestData();
		str+=data;
		dataValues.add(data);	
	...
	public String getSouthEast(Mat mat, Point center) {
		...
		offset = extractEastValue(mat, x, offset+5);
		data = findBestData();
		str+=data;
		dataValues.add(data);
